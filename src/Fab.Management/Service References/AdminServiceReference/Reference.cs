...
namespace Fab.Managment.AdminServiceReference {
    ...
    public partial class AdminUserDTO : Fab.Managment.AdminServiceReference.UserDTO {
        ...
        public string Passoword {
            get {
                return this.PassowordField;
            }
            set {
                if ((object.ReferenceEquals(this.PassowordField, value) != true)) {
                    this.PassowordField = value;
                    this.RaisePropertyChanged("Passoword");
                }
            }
        }
    }
