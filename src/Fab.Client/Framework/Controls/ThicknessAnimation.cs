...
namespace Fab.Client.Framework.Controls
{
	namespace SLApp1
	{
		namespace Custom.Animations
		{
			...
			{
				public static readonly DependencyProperty ElementProperty = DependencyProperty.RegisterAttached("Element",
				                                                                                                typeof (
					                                                                                                DependencyObject),
				                                                                                                typeof (
					                                                                                                DoubleAnimation),
				...
				public static DependencyProperty TimeProperty = DependencyProperty.RegisterAttached("Time", typeof (double),
				...
				public static DependencyProperty TargetProperty = DependencyProperty.RegisterAttached("Target",
				                                                                                      ...
				                                                                                      typeof (ThicknessAnimationX),
				                                                                                      null);

				public static DependencyProperty TargetPropertyProperty = DependencyProperty.RegisterAttached("TargetProperty",
				                                                                                              typeof (
					                                                                                              DependencyProperty),
				                                                                                              typeof (
					                                                                                              DependencyObject),
				...
				public static readonly DependencyProperty ToProperty = DependencyProperty.RegisterAttached("To", typeof (Thickness),
				                                                                                           typeof (DoubleAnimation),
				                                                                                           null);
				...
				private static void OnElementPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
				{
					if (e.NewValue != null)
					{
						...
						doubleAnimation.SetValue(TargetPropertyProperty, Border.BorderThicknessProperty);
