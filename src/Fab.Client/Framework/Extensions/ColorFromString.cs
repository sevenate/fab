// <copyright file="ColorFromString.cs" company="nReez">
// 	Copyright (c) 2009-2011 nReez. All rights reserved.
// </copyright>
// <author name="Jim McCurdy" url="http://yinyangme.com/blog/post/ColorFromString-for-Silverlight-or-NET.aspx" date="2009-07-24" />
...
{
	/// <summary>
	/// Convert string color representation into <see cref="Color"/> instance.
	/// </summary>
	public static class ColorFromString
	{
		...
		private static bool IsHexColor(string value)
		{
			...
			return value.ToCharArray().All(c => Uri.IsHexDigit(c));
		}
