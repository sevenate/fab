...
namespace Fab.Server.Import.UserServiceReference {
    ...
    public interface IUserService {
        ...
        Fab.Server.Import.UserServiceReference.UserDTO Register(string login, string password);
        ...
        Fab.Server.Import.UserServiceReference.UserDTO EndRegister(System.IAsyncResult result);
        ...
        Fab.Server.Import.UserServiceReference.UserDTO GetUser(string login, string password);
        ...
        Fab.Server.Import.UserServiceReference.UserDTO EndGetUser(System.IAsyncResult result);
    ...
    public partial class RegisterCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        public Fab.Server.Import.UserServiceReference.UserDTO Result {
            get {
                base.RaiseExceptionIfNecessary();
                return ((Fab.Server.Import.UserServiceReference.UserDTO)(this.results[0]));
            }
        }
    }
    ...
    public partial class UserServiceClient : System.ServiceModel.ClientBase<Fab.Server.Import.UserServiceReference.IUserService>, Fab.Server.Import.UserServiceReference.IUserService {
        ...
        public Fab.Server.Import.UserServiceReference.UserDTO Register(string login, string password) {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        public Fab.Server.Import.UserServiceReference.UserDTO EndRegister(System.IAsyncResult result) {
        ...
        private object[] OnEndRegister(System.IAsyncResult result) {
            Fab.Server.Import.UserServiceReference.UserDTO retVal = this.EndRegister(result);
            return new object[] {
                    retVal};
        }
        ...
        public Fab.Server.Import.UserServiceReference.UserDTO GetUser(string login, string password) {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        public Fab.Server.Import.UserServiceReference.UserDTO EndGetUser(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetUser(object[] inValues, System.AsyncCallback callback, object asyncState) {
            string login = ((string)(inValues[0]));
            string password = ((string)(inValues[1]));
            return this.BeginGetUser(login, password, callback, asyncState);
        }
        
        private object[] OnEndGetUser(System.IAsyncResult result) {
            Fab.Server.Import.UserServiceReference.UserDTO retVal = this.EndGetUser(result);
            return new object[] {
                    retVal};
        }
